...
const Map<String, String> urls = {
  ...
  "notion": "https://api.notion.com/v1/oauth/authorize?"+ "client_id=69156507-b2a0-46ac-aea9-afe5a4227b1f"+ "&response_type=code&owner=user"
};

Future<Tuple3<String, String, bool>> interceptToken(
...
void registerOauth(BuildContext context, String serviceName) async {
  ...
  await server.forEach((HttpRequest request) {
    ...
    request.response.close();
    server.close();
    interceptToken(context, serviceName, code).then((value) {
